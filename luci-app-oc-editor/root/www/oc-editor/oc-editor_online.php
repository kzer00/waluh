...
$root_path = '/etc/config/openclash';
...
if (isset($_GET['upload']) && !FM_READONLY) {
	...
	<script type='text/javascript'>
		try {
			var dropzone_min_css = 'https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.3/min/dropzone.min.css';
		}
		catch {
			var dropzone_min_css = 'cdn/dropzone.min.css';
		}
		document.write('<link href="' + dropzone_min_css + '" rel="stylesheet">');
	</script>
	...
	<script type='text/javascript'>
		try {
			var dropzone_min_js = 'https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.3/min/dropzone.min.js';
		}
		catch {
			var dropzone_min_js = 'cdn/dropzone.min.js';
		}
		document.write('<script src="' + dropzone_min_js + '"></script>');
	</script>
...
function fm_get_file_mimes($extension)
{
	...
	$fileTypes['yaml'] = ['text/plain'];
	$fileTypes['yml'] = ['text/plain'];
...
<head>
	...
	<script type='text/javascript'>
		try {
			var bootstrap_min_css = 'https://stackpath.bootstrapcdn.com/bootstrap/5.2.2/css/bootstrap.min.css';
		}
		catch {
			var bootstrap_min_css = 'cdn/bootstrap.min.css';
		}
		document.write('<link rel="stylesheet" href="' + bootstrap_min_css + '">');
	</script>
...
<script type='text/javascript'>
	try {
		var jquery_slim_min_js = 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.slim.min.js';
		var bootstrap_min_js = 'https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js';
	}
	catch {
		var jquery_slim_min_js = 'cdn/jquery.slim.min.js';
		var bootstrap_min_js = 'cdn/bootstrap.min.js';
	}
	document.write('<script src="' + jquery_slim_min_js + '"></script>');
	document.write('<script src="' + bootstrap_min_js + '"></script>');
</script>
...
<head>
	...
	<script type='text/javascript'>
		try {
			var bootstrap_min_css = 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css';
			var fontawesome_min_css = 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css';
			var ekko_lightbox_css = 'https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css';
		}
		catch {
			var bootstrap_min_css = 'cdn/bootstrap.min.css';
			var fontawesome_min_css = 'cdn/font-awesome.min.css';
			var ekko_lightbox_css = 'cdn/ekko-lightbox.css';
		}
		document.write('<link rel="stylesheet" href="' + bootstrap_min_css + '">');
		document.write('<link rel="stylesheet" href="' + fontawesome_min_css + '">');
		document.write('<link rel="stylesheet" href="' + ekko_lightbox_css + '" />');
	</script>
	<link rel="stylesheet" href="cdn/bootstrap.min.css">
	...
	<script type='text/javascript'>
		try {
			var fm_highlight_js = "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.6.0/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css";
		}
		catch {
			var fm_highlight_js = 'cdn/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css';
		}
		document.write('<link rel="stylesheet" href="' + fm_highlight_js + '">');
	</script>
...
<script type='text/javascript'>
	try {
		var jquery_min_js = 'https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js';
		var bootstrap_min_js = 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js';
		var jquery_dataTables_min_js = 'https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js';
		var absolute_js = 'https://cdn.datatables.net/plug-ins/1.11.5/sorting/absolute.js';
		var ekko_lightbox_min_js = 'https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js';
	}
	catch {
		var jquery_min_js = 'cdn/jquery.min.js';
		var bootstrap_min_js = 'cdn/bootstrap.min.js';
		var jquery_dataTables_min_js = 'cdn/jquery.dataTables.min.js';
		var absolute_js = 'cdn/absolute.js'
		var ekko_lightbox_min_js = 'cdn/ekko-lightbox.min.js';
	}
	document.write('<script src="' + jquery_min_js + '"></script>');
	document.write('<script src="' + bootstrap_min_js + '"></script>');
	document.write('<script src="' + jquery_dataTables_min_js + '"></script>');
	document.write('<script src="' + absolute_js + '"></script>');
	document.write('<script src="' + ekko_lightbox_css + '"></script>');
</script>
<script src="cdn/jquery.min.js"></script>
<script src="cdn/bootstrap.min.js"></script>
<script src="cdn/jquery.dataTables.min.js"></script>
<script src="cdn/absolute.js"></script>
...
<?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])): ?>
	...
	<script type='text/javascript'>
		try {
			var highlight_min_js = 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.6.0/highlight.min.js';
		}
		catch {
			var highlight_min_js = 'cdn/highlight.min.js';
		}
		document.write('<script src="' + highlight_min_js + '"></script>');
	</script>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE):
	...
	<script type='text/javascript'>
		try {
			var ace_js = 'https://cdnjs.cloudflare.com/ajax/libs/ace/1.13.1/ace.js';
		}
		catch {
			var ace_js = 'cdn/ace.js';
		}
		document.write('<script src="' + ace_js + '"></script>');
	</script>
